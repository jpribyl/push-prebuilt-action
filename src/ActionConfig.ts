...
export function assertIsActionConfig(
  actionConfig: any
): asserts actionConfig is ActionConfig {
...
export function assertIsDockerActionConfig(
  dockerActionConfig: any
): asserts dockerActionConfig is DockerActionConfig {
...
export function assertIsJavaScriptActionConfig(
  javaScriptActionConfig: any
): asserts javaScriptActionConfig is JavaScriptActionConfig {
